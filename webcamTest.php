    ...
    <section>
        <div id="add_image">
            ...
            while ($display_gallery = $ret->fetch())
            {
                ?>
                <div>
                    <img id=past_upload" src="<?= $display_gallery->path_to_photo;?>" /> <br/><br/>
                </div>
                <?php
            }
            ?>
        ...
        <div id="image">
            ...
            <div id="webcam" class="tabcontent">
                ...
                <a href="webcamDataTest.php"><button id="startbutton"> Take a photo </button></a><br/>
                <!--<a href="webcamTest.php"><button onclick="uploadPic()"> Upload photo </button></a><br/>-->
            ...
            <div id="file_upload" class="tabcontent" style="display: block">
                <form method="post" action="webcamDataTest.php" enctype="multipart/form-data" id="form">
        ...
        <div id="edit_image">
            <div id="watermarks">
                ...
                <form method="post" id="final_submit" action="webcamDataTest.php">
